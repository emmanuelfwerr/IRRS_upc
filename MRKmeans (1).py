    ...
    for i in range(args.iter):
        ...
        with mr_job1.make_runner() as runner1:
            ...
            # If your scripts returns the new assignments you could write them in a file here
             #assign_prototype has to return the new assignments and we should store it in a file
             # and we should maybe take it from the file and store it in new-assign
            ...
            #compare the assignments to the new_proto in th next iteration , if it doesn't change we reached our final iteration
            #it means convergence or we stop when we reach a number of iterations
            #The process stops when there are no changes between two consecutive iterations or a specific number of iterations is reached.
            #use the ProcessResults.py script to process the prototypes of the last iteration
            #save all in a file 
            #we should check if the assignments are changing from an iteration to another 
